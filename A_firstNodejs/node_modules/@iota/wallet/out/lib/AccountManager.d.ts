...
import type { AccountId, Auth, EventType, AccountManagerOptions, CreateAccountPayload, NodeInfoWrapper, ClientOptions, AccountSyncOptions, WalletEvent, LedgerNanoStatus } from '../types';
...
export declare class AccountManager {
     ...
     */
    recoverAccounts(accountStartIndex: number, accountGapLimit: number, addressGapLimit: number, syncOptions: AccountSyncOptions): Promise<Account[]>;
    /**
